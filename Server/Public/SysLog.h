...
#define     LOGLVL_INFO        0x0001          // 正常信息:连接类;
#define     LOGLVL_TRACE       0x0002          // 痕迹信息:消息接收与发送;
#define     LOGLVL_DEBUG       0x0004          // 调试信息:打印特定参数;
#define     LOGLVL_ERROR       0x00F0          // 错误信息:打印错误提示;


// 日志消息
void DEBUG_MSG(int _level, char * _format, ...);
